...
import petsImage from "@/assets/pets-category.jpeg";
...
const HomeSection = ({ onTabChange }: HomeSectionProps) => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Conoce nuestros puntos de venta y aliados estratégicos",
...
<br /><br /><br />
  <div className="relative z-10 flex flex-col lg:flex-row items-center h-full px-6 lg:px-20 py-12">
          <div className="w-full lg:w-1/2 pr-0 lg:pr-12">
            ...
            <h2 className="text-lg md:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight drop-shadow-lg">
